...
const ApproachStep: React.FC<ApproachStepProps> = ({
  ...
  return <div className="flex flex-col items-center text-center">
      <div className="w-16 h-16 text-white rounded-full flex items-center justify-center mb-4 bg-blue-500 py-[4px]">
        {icon}
      </div>
...
const ApproachSection: React.FC = () => {
  ...
  return <section id="approach" className="bg-aiix-lightgray py-20">
      <div className="section-container">
        ...
        <div className="grid grid-cols-1 md:grid-cols-5 gap-8">
          {approachSteps.map((step, index) => <React.Fragment key={index}>
              <ApproachStep {...step} />

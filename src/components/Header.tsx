...
const Header: React.FC<HeaderProps> = () => {
  ...
  return <header className={`fixed w-full z-50 transition-colors duration-300 ${scrolled ? 'bg-aiix-primary/90 backdrop-blur-md' : ''}`}>
      <div className="container mx-auto flex justify-between items-center h-[18px] px-[23px] py-[21px]">
        ...
        <button className="md:hidden text-white" onClick={() => setMobileMenuOpen(!mobileMenuOpen)}>
          {mobileMenuOpen ? <svg xmlns="http://www.w3.org/2000/svg" className="h-3 w-3" fill="none" viewBox="0 0 24 24" stroke="currentColor">
